            ...
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                 ...
                 <#if ylrc_user.headPic?length gt 0>
                	<img class="img-avatar img-avatar-48 m-r-10" src="/photo/view?filename=${ylrc_user.headPic}" alt="${ylrc_user.nickName!""}" />
                 <#else>
                 	<img class="img-avatar img-avatar-48 m-r-10" src="/admin/images/default-head.jpg" alt="${ylrc_user.nickName!""}" />
                 </#if>
                 </#if>
                <span>${ylrc_user.nickName!""} <span class="caret"></span></span>
              </a>
